...
export default defineNitroPlugin(async (nitro) => {
  ...
  const build = await BuildModel.create({
    ...
    cpu: "665cbcef86ab007be77b0fb3",
    gpu: "665cbcef86ab007be77b0fb6",
    ram: "665cbcef86ab007be77b0fb9",
    drive: "665cbcef86ab007be77b0fbc",
    cooling_system: "665cbcef86ab007be77b0fc3",
    decoration: "665cbcef86ab007be77b0fcb",
    motherboard: "665cbcef86ab007be77b0fbf",
    psu: "665cbcef86ab007be77b0fc8",
    pc_case: "665cbcef86ab007be77b0fc5",
    wall_of_builds: true,
  });
  ...
  //   name: "Build 2",
  //   cpu: "Intel Core i5 14600KF 24 M Cache",
  //   gpu: "NVIDIA GeForce RTX 4090",
  //   ram: "G.Skill Trident Z RGB",
  //   cooling_system: "Corsair H150i Elite Capellix",
  //   decoration: "RGB Fans (120mm)",
  //   motherboard: "ASUS ROG Strix Z790-E Gaming WiFi",
  //   psu: "EVGA SuperNOVA 750 G5",
  //   pc_case: "NZXT H510",
  //   drive: "Samsung 970 EVO Plus NVMe SSD",
  // });
  ...
  //   cooling_system: "be quiet! Dark Rock Pro 4",
  //   decoration:
  //     "LED Display Panel (Acrylic Panel with Customizable LED Lighting)",
  //   motherboard: "MSI MPG B550 Gaming Edge WiFi",
  //   psu: "Seasonic Focus GX-650",
  //   pc_case: "Fractal Design Meshify C",
  //   drive: "Western Digital Blue 3D NAND SATA SSD",
  // });
});
